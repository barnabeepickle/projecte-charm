...
[Modrinth Page](https://modrinth.com/mod/projecte-charms) - [Curseforge Page](https://www.curseforge.com/minecraft/mc-mods/projecte-charms)
...
I've been trying to get better at making Minecraft mods and had an idea while playing modded Minecraft a while ago for making an item that when equiped as a bauble would let you open the ProjectE Transmutation GUI, since I already had written some code for [Make Panorama](https://github.com/barnabeepickle/MakePanorama) I decided to make a small addon for ProjectE adding just that.

## Modpacks

If you want to include this mod in a modpack feel free to do so.

##  Issues

If you notice an issue and want to make me aware please report here [barnabeepickle/projecte-charm/issues](https://github.com/barnabeepickle/projecte-charm/issues).

## Pull-Requests

If you want to help fix an issue improve the mod or more I am happy to merge pull requests.

When it comes to feature additions I will merge them if they align with want I want in this mod but if I don't and you still want the feature you could aways fork the mod remove all the already existing features and use the codebase to make a new ProjectE addon.

## Forks

This project is licensed under the MIT License but I have one further stipulation:

You may not under any circumstances remove, disable by default or otherwise eliminate LGBTQIA+ content from this mod unless for the explicit purpose of creating a new ProjectE addon that implements soley new gameplay content.
