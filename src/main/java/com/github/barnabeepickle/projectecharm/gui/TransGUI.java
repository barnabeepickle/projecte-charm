...
public class TransGUI extends GuiContainer
{
    public static ResourceLocation texture = new ResourceLocation(Tags.MODID, "textures/gui/trans.png");
    public final TransmutationInventory inv;
    public GuiTextField textBoxFilter;

    public TransGUI(InventoryPlayer invPlayer, TransmutationInventory inventory, @Nullable EnumHand hand) {
    ...
    protected void renderHoveredToolTip(int mouseX, int mouseY) {
        ...
        if (mouseX > emcLeft && mouseX < emcRight && mouseY > emcTop && mouseY < emcBottom) {
            ...
            drawHoveringText(List.of(emcAsString), mouseX, mouseY);
        } else {
            super.renderHoveredToolTip(mouseX, mouseY);
        }
    }
